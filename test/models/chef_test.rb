...
class ChefTest < ActiveSupport::TestCase
   ...
   test "Email validation should accept valid address" do
       valid_addresses = %w[user@eee.com R_TDD-DS@eee.hello.org user@example.com first.name@user.net]
   ...
   test "Email validation should reject invalid addresses" do
      invalid_addresses = %w[user@example,com user_at_222.org user@name user@@com] 
